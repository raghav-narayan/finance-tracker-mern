...
export const getAllTransactionController = async (req, res) => {
  try {
    const { userId, type, frequency, startDate, endDate, category, newInput } = req.body;
    ...
    // Add partial match search for the title if newInput exists
    if (newInput) {
      query.title = { $regex: newInput, $options: 'i' }; // 'i' for case-insensitive search
    }
    ...
    // Fetch the transactions based on the constructed query

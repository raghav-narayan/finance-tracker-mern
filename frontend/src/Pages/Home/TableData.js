...
import "./home.css";
import { deleteBudget, deleteTransactions, editTransactions } from "../../utils/ApiRequest";
...
// const [view,setView] = useState('budget')
  ...
  const handleBudgetDeleteClick = async (itemKey) => {
    console.log(user._id);
    console.log("Clicked button ID delete:", itemKey);
    setCurrId(itemKey);
  ...
  }, [props.data,props.user, refresh,props.budgets]);
        ...
        (<Table responsive="md" className="data-table">
          ...
          <tbody className="text-white">
            {props.data.map((item, index) => (
              <tr key={index}
                className={item.transactionType === 'expense' ? 'expense-row':'income-row'}>
        ...
        <Table responsive="md" className="data-table">
          ...
          <tbody className="text-white">
            {props.budgets.map((item, index) => (
              <tr key={index}>
                <td>{moment.utc(item.date).format("MMM YYYY")}</td>
                ...
                <td>
                  <div className="icons-handle">
                    ...
                    <DeleteForeverIcon
                      ...
                      key={index}
                      id={item._id}
                      onClick={() => handleBudgetDeleteClick(item._id)}
                    />
